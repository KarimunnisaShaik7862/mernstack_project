...
import volunteerImage1 from './stray dog.jpg';
import volunteerImage2 from './feed a stray dog.jpg';
    ...
    <div className="volunteer-page">
      <div className="left-side">
        ...
        <div className="side-content">
          <h2>Share Your Love, Feed a Stray</h2>
          <p>Your donation can provide food and care for stray dogs, ensuring they receive the nourishment and compassion they deserve, one bowl at a time.</p>
